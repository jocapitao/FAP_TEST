...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 08-Nov-2018 às 21:36
...
(3, 71, 'Cesar Correia', NULL, '<option data-tokens=\"{{$club[\'league_native\']}}\" {{( in_array($c,json_decode($profile[\'content\'][\'data\'][\'clubs\'],true) ) ? \'selected\' :\'\')}}>{{$c}}</option>', 'FC Porto', '[\"FC Porto\",\"V. Set\\u00fabal\",\"Chaves\"]', 1, '[\"en\",\"fr\",\"pt\"]', '2018-11-06 18:20:36', '2018-10-30 17:12:55', 1);
...
INSERT INTO `fap_houses` (`id`, `user_id`, `name`, `location`, `guest_nr`, `property_type_id`, `stay_price_type`, `price`, `beds`, `available_days`, `transport_provider`, `meals`, `night_fun`, `airport_pickup`, `visits`, `rates`, `commodities`, `installations`, `cleaning_fee`, `rules`, `currency_id`, `form_id`, `created_at`, `updated_at`, `slug`, `status`) VALUES
(44, 71, 'The Great', '4410-254', '3', 24, 'price_night', 33, '[\"double_bed\"]', '[\"2019-01-03 to 2019-01-17\"]', 1, '{\"meal_q\":\"on\",\"meal_pq\":\"on\",\"meal_price\":45}', '{\"night_q\":false}', '{\"pickup_q\":false}', '{\"visits_q\":false}', '{\"rate_q\":\"standard_rate\",\"rates_code\":\"PT\"}', '[\"kitchen\",\"washing_machine\"]', '[\"gym\"]', NULL, 'null', 1, '98f8ff6cf388128537b404f5345b820a', '2018-10-18 14:11:38', '2018-11-06 16:30:33', '5-the-great', 1),
(42, 71, 'ORGA', 'Porto, Portugal', '5', 21, 'price_night', 88, '[\"double_bed\"]', '\"2018-10-16, 2018-10-17, 2018-10-19, 2018-10-20, 2018-10-24, 2018-10-23, 2018-10-22\"', 1, '{\"meals_q\":\"on\",\"meals_qp\":false}', '{\"night_q\":false}', '{\"pickup_q\":false}', '{\"visits_q\":\"on\",\"visits_qp\":false}', '{\"rate_q\":\"standard_rate\",\"rates_code\":\"BG\"}', '[\"kitchen\",\"toilet\"]', '[\"parking\",\"jacuzzi\"]', NULL, '[\"no-smoking\",\"no-parties\"]', 2, '06a1c70cd34c4f880bf9d2c078c18fac', '2018-10-03 14:47:03', '2018-11-06 15:47:49', '19-orga', 1),
(43, 71, 'Johny Tell', 'Madrid, Spain', '2', 22, 'price_night', 33, '[\"single_bed\",\"king_bed\"]', '\"2018-10-01 to 2018-10-30\"', 1, '{\"meal_q\":\"on\",\"meal_pq\":\"on\",\"meal_price\":10}', '{\"night_q\":false}', '{\"pickup_q\":false}', '{\"visits_q\":\"on\",\"visits_pq\":\"on\",\"visits_price\":44}', '{\"rate_q\":\"standard_rate\",\"rates_code\":\"PT\"}', '[\"kitchen\",\"toilet\",\"washing_machine\",\"intercomunicator\",\"door_man\",\"iron\",\"wifi\",\"cable_tv\",\"auto_check\",\"smoke_detector\"]', '[\"parking\",\"gym\",\"jacuzzi\",\"pool\"]', NULL, '[\"no-parties\",\"no-smoking\"]', 1, '73a5650df76975c22fe51caaffbb6172', '2018-10-04 11:03:19', '2018-11-06 13:06:11', '17-johny-tell', 1);
...
(1, 71, 1, 1, '2018-08-07 10:17:01', '2018-11-07 17:27:32'),
