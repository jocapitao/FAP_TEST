...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 04-Dez-2018 às 14:21
...
CREATE TABLE IF NOT EXISTS `fap_checkout_processes` (
  ...
  `night_activities` int(11) DEFAULT NULL,
