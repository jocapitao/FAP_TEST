            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="float-right text-success">
                        <small class="ion ion-md-arrow-round-up text-tiny"></small>
                        12%
                    </div>
        ...
        <div class="col-sm-6 col-xl-3">
            ...
            <div class="card mb-4">
                <h6 class="card-header bg-success text-white">
                    <i class="ion ion-md-cash"></i>&nbsp; Revenue
                </h6>
                            ...
                            <div class="card-body">
                                <div class="rounded ui-bordered p-3 mb-3">
                                    ...
                                    <div class="media align-items-center mt-3">
                                        <img src="{{asset('admin/')}}/img/avatars/12-small.png"
                                ...
                                <div class="rounded ui-bordered p-3">
                                    ...
                                    <div class="media align-items-center mt-3">
                                        <img src="{{asset('admin/')}}/img/avatars/10-small.png"
                                             class="d-block ui-w-30 rounded-circle" alt>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <h6 class="card-header with-elements">
                    ...
                    <div class="card-header-elements ml-auto">
                        <button type="button" class="btn btn-default btn-xs md-btn-flat">Show more
                        </button>
                    </div>
                </h6>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="media pb-1 mb-3">
                        <img src="{{asset('admin/')}}/img/avatars/9-small.png" class="d-block ui-w-40 rounded-circle"
                             alt>
                        <div class="media-body ml-3">
                            ...
                            <p class="my-1">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                    ...
                    <div class="media pb-1 mb-3">
                        <img src="{{asset('admin/')}}/img/avatars/8-small.png" class="d-block ui-w-40 rounded-circle"
                             alt>
                        <div class="media-body ml-3">
                            <a href="javascript:void(0)">Hallie Lewis</a>
                            <span class="text-muted">commented on</span>
                            <a href="javascript:void(0)">Article Name</a>
                            <p class="my-1">Vivendum torquatos ut nec, sit audiam deterruisset ei, cu
                                sed nibh autem scriptorem. Ea quo vidit deleniti constituto, ex qui
                                malis mollis iudicabit, viris fabellas id has.</p>
                            <div class="clearfix">
                                <a href="javascript:void(0)" class="float-right text-lightest small">
                                    <span class="ion ion-ios-thumbs-down"></span>
                                </a>
                    ...
                    <div class="media">
                        <img src="{{asset('admin/')}}/img/avatars/7-small.png" class="d-block ui-w-40 rounded-circle"
                             alt>
                        <div class="media-body ml-3">
                            <a href="javascript:void(0)">Alice Hampton</a>
                            <span class="text-muted">commented on</span>
                            <a href="javascript:void(0)">Article Name</a>
                            <p class="my-1">Eam facilis laboramus reprehendunt ei, ex esse fastidii
                                per.</p>
                            <div class="clearfix">
                                <a href="javascript:void(0)" class="float-right text-lightest small">
                                    <span class="ion ion-ios-thumbs-down"></span>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="pb-1 mb-3">
                        ...
                        <a href="javascript:void(0)">Sit meis deleniti eu, pri vidit meliore docendi
                            ut?</a>&nbsp;
                        <span class="text-muted">#34563</span>
                        <br>
                        <small class="text-muted">Created by
                    ...
                    <div class="pb-1 mb-3">
                        ...
                        <a href="javascript:void(0)">Eu tantas offendit mnesarchum sit, vide novum ad
                            pri.</a>&nbsp;
                        <span class="text-muted">#34563</span>
                        <br>
                        <small class="text-muted">Created by
